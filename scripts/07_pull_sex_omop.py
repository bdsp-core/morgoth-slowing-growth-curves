...
Prereqs (see docs/omop-query-instructions.txt):
  1. Open the SSH tunnel to the myelin bastion (host from Brandon):
       ssh -i ~/Desktop/GithubRepos/AWSKeys/StanfordAWS_keys/myelin-bastion-key.pem -N \
           -L 5433:bdsp-omop-aurora-instance-1.cz06iykeon5i.us-west-2.rds.amazonaws.com:5432 \
           ec2-user@<MYELIN_BASTION_HOST>
