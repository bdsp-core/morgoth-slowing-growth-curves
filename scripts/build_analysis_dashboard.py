...
CHECKLIST = [
    ("Cohort & normative curves", [
        ...
        ("todo", "Homologous-asymmetry norms vs age (for lateralization deviation)"),
    ]),
...
SECTIONS = [
    ("Cohort & normative growth curves",
     ...
     [(CURVE / "rel_delta__whole_head.png", "Relative delta vs age (whole head), normal percentile curve."),
...
CAP_MD = [("results/lateralization_by_band.md", "Lateralization — band-matched detail"),
...
<div class="wrap">
  ...
  <div class="sub">Every evaluation the paper needs, with status + captioned results. Curate the checklist;
    ✓ = have it, ○ = planned. Companion to the ingestion burndown.</div>
