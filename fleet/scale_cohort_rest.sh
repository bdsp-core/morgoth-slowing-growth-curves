#!/usr/bin/env bash
# COHORT RECOMPUTE fleet — reprocess the routine cohort (manifest_cohort_rest.jsonl) through the SAME pipeline
...
rclone copyto $CODE/manifest_cohort_rest.jsonl fleet/manifest_cohort_rest.jsonl
...
export DYNAMIC=1 SEED=\$RANDOM\$RANDOM S3_OUT=$S3OUT MANIFEST_LOCAL=/home/ubuntu/morgoth-slowing-growth-curves/fleet/manifest_cohort_rest.jsonl
...
CUR=${CUR:-0}; NEED=$TARGET   # additive: launch exactly N more
