...
rclone copyto $CODE/manifest_pilot.jsonl fleet/manifest_pilot.jsonl
...
export DYNAMIC=1 SEED=\$RANDOM\$RANDOM S3_OUT=$S3OUT MANIFEST_LOCAL=/home/ubuntu/morgoth-slowing-growth-curves/fleet/manifest_pilot.jsonl
