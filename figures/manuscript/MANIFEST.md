...
|---|---|---|---|---|---|
| `Figure1_normative_model.png` | 2 (keystone_growth_grid.png, topo_rel_delta_by_age_stage.png) | `scripts/76, 77` | 152 x 240 | 1.13 | 300 |
| `Figure2_detection.png` | 2 (s0d_single_occasion_generalized.png, s0e_occasion_focal.png) | `scripts/54, 55, 66` | 190 x 192 | 1.41 | 300 |
| `Figure3_sandor_external.png` | 1 (sandor100_slowing.png) | `scripts/sandor100_external_validation` | 190 x 88 | 1.34 | 300 |
...
| `FigureS5_curvebank.png` | 3 (rel_delta__whole_head.png, TAR__whole_head.png, DAR__whole_head.png) | `scripts/111` | 190 x 232 | 1.44 | 301 |
| `FigureS8_description_panels.png` | 4 (s4_d1.png, s4_d3.png, s4_d4.png, s4_d6.png) | `scripts/57, 58` | 159 x 240 | 1.21 | 300 |
| `FigureS7_localized_focal.png` | 1 (s0_occasion_ours_v4_focal.png) | `scripts/49` | 190 x 92 | 1.34 | 300 |
| `FigureS9_severity_null.png` | 1 (severity_recalibrated.png) | `scripts/109` | 190 x 91 | 1.34 | 300 |
| `FigureS3_vanputten.png` | 1 (vanputten_panel_s7.png) | `scripts/vanputten_panel_s7` | 190 x 102 | 1.34 | 300 |
| `FigureS4_topoplot_TAR.png` | 1 (topo_TAR_by_age_stage.png) | `scripts/77` | 190 x 116 | 1.34 | 300 |
