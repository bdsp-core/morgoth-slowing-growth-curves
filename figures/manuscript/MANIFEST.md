...
| `FigureS5_curvebank.png` | 3 (rel_delta__whole_head.png, TAR__whole_head.png, DAR__whole_head.png) | `scripts/111` | 190 x 232 | 1.44 |
| `FigureS8_description_panels.png` | 4 (s4_d1.png, s4_d3.png, s4_d4.png, s4_d6.png) | `scripts/57, 58` | 159 x 240 | 1.21 |
