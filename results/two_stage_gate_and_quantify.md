...
- **Morgoth gate: AUROC 0.900** [0.822, 0.963] against the expert majority
- our S as a detector: 0.909 [0.842, 0.962] — reported only to show that this is not the quantity it is for
- **S(generalized) across consensus groups: Kruskal–Wallis p = 2.72e-07**
  - focal only: median -0.24 vs neither -0.38 (Mann–Whitney p = 2.4e-01, n = 13)
  - generalized only: median +0.77 vs neither -0.38 (Mann–Whitney p = 3.3e-08, n = 18)

## focal slowing

- **Morgoth gate: AUROC 0.923** [0.817, 0.995] against the expert majority
- our S as a detector: 0.848 [0.731, 0.945] — reported only to show that this is not the quantity it is for
- **S(focal) across consensus groups: Kruskal–Wallis p = 1.31e-05**
  - focal only: median +0.23 vs neither -0.14 (Mann–Whitney p = 3.0e-05, n = 13)
  - generalized only: median -0.07 vs neither -0.14 (Mann–Whitney p = 5.7e-03, n = 18)
