...
- LENS (full): Right temporal theta–delta (mixed) slowing, maximal over the right temporal region, peaking at T4 (the T4-T6 derivation). Peak deviation 1.9 SD above the age- and stage-matched normal at that region (97th centile), abnormal in 11% of analysed segments (frequent); longest continuous run ≈0.7 min over 18 episodes. Present only during sleep; most prominent in REM sleep.  
