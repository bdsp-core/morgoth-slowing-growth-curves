...
|---|---|---|---|---|---|---|
| focal | 14/100 | **0.787** | 0.801 | 0.714 | nan | **BELOW** |
| generalized | 19/100 | **0.861** | 0.809 | 0.684 | 0.735 | **MEETS/EXCEEDS** |

## Verdict — the claim is axis-specific, and it survives where it was made

**Generalized slowing: the claim HOLDS on v6.** Balanced accuracy **0.861** against an expert ceiling of 0.809 — the legacy figure was 0.835 vs 0.809, so the result is reproduced and slightly stronger. The abstract's honest caveat also reproduces almost exactly: at the experts' own specificity, S reaches sensitivity 0.684 versus the experts' 0.735 — it beats them on the balanced operating point, not at theirs.

**Focal slowing: the claim does NOT hold.** Balanced accuracy 0.787 against a ceiling of 0.801. The abstract never claimed focal, and it must not start.
