...
**Objective.** Reading EEG slowing stays qualitative and age- and state-dependent; existing lifespan norms give normal values, not deviation, and are mostly awake. We built a lifespan, sleep-stage-resolved deviation-from-normal instrument for EEG slowing.
